...
const fragmentShader = `
    ...
    void main() {
        ...
        //  vec3 yellowColor =  vec3(1, 0.976, 0.612);
            ...
            //option 3 orange
         vec3 greenColor =  color1;
       vec3 yellowColor =  color2;
...
export default function Data(props) {
  ...
  useEffect(() => {
    ...
    const colorFolder = gui.addFolder("Data") 
    const dataColor1 = colorFolder.addColor(geometryBaseColor, "color1")
    dataColor1.onChange((value) => {
     mesh.current.material.uniforms.color1.value = new THREE.Color(value)
    })

    const dataColor2 = colorFolder.addColor(geometryBaseColor, "color2")
    dataColor2.onChange((value) => {
  ...
  const uniforms = useMemo(
    () => ({
        ...
        color1: { value:new THREE.Color( 0xdaff00)},
